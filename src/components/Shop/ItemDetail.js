                ...
                <div className='h-4/5 w-10/12 mt-12 mb-20 mx-auto flex flex-col md:flex-row md:space-x-24 space-y-6 md:space-y-0 justify-between'>
                    ...
                    <div className='w-full md:w-2/5 flex flex-col divide-y-2 space-y-8'>
                        <div className='space-y-8'>
                            ...
                            <div>
                                <p className='font-body leading-relaxed text-gray-700'> The {product.name} is a beautiful, statement piece and all for you it can brighten your day
                            ...
                            <div className='flex'>
                                ...
                                <FontAwesomeIcon className='text-gray-800' icon={faStar}/>
                                <FontAwesomeIcon className='text-gray-800' icon={faStar}/>
                                <p className='font-display font-light text-sm text-gray-600 tracking-wider pl-2 underline cursor-pointer hover:text-gray-900'>4,650 Reviews </p>
                          </div>
                        </div>
                        <div>
                            ...
                            <div className='flex-col space-y-5'>
                                <h2 className='font-bidy font-semibold mt-4 text-gray-700 w-8 h-8 rounded-full cursor-pointer'>Details</h2>
                                <div className='flex-col space-y-5'>
                                    <div className='flex'>
                                    ...
                                    <div className='flex justify-around pt-4'>
                                     <p className='w-24 font-body text-gray-600 hover:text-gray-900'> Handle with Care </p>
                                     </div>
                                </div>
                            </div>
                        </div>
