  ...
  return (
        <nav className='flex h-18 py-4 w-full m-auto text-gray-800'> 
            ...
            <ul className='flex justify-end items-end pr-4 md:pr-24 w-full space-x-6 md:space-x-12 font-display font-thin md:font-light'>
                <Link to='/about'>
                    <li className='text-sm md:text-lg transition duration-300 transform hover:-translate-y-1 hover:text-green-500 hover:font-normal border-green-500 hover:border-b-2'>About</li>
                </Link>
                <Link to='/Shop'>
                    <li className='text-sm md:text-lg transition duration-300 transform hover:-translate-y-1 hover:text-green-500 hover:font-normal border-green-500 hover:border-b-2'>Shop</li>
                </Link>
                <li 
                    onClick = {() => dispatch(displayCart())}
                    className='transition duration-300 transform hover:-translate-y-1 hover:text-green-500 
                    hover:font-normal border-green-500 hover:border-b-2'
                >
