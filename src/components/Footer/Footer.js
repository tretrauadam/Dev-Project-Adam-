        ...
        <footer className='bg-gray-200 bg-opacity-40 w-screen pt-8 pb-28'>
            <div className='flex flex-col md:flex-row justify-center w-5/6 2xl:w-7/12 m-auto justify-between
                ...
                <div className='text-center md:text-left m-auto w-full md:w-0'>
                    ...
                    <p className='font-body py-4 w-72 text-gray-700'>Get more information .</p>
                    <div className='flex mt-6'>
                        <input className='h-12 p-4 rounded-l font-body bg-cyan-100 border-black-400 border hover:border-gray-700 focus:border-gray-700 focus: border-2 focus:outline-none' 
                            type='text' 
                ...
                <div className='flex space-x-6 md:space-x-24'>
                    ...
                    <div className='flex flex-col space-y-4'>
                        ...
                        <p className='font-body text-sm text-gray-700'>greenify@email.com</p>
                        <div className='flex space-x-6'>
                            <a href='https://github.com/jtcaovan' target='_blank rel="noopener noreferrer"'>
                                <FontAwesomeIcon className='text-xl md:text-2xl text-gray-700 hover:text-green-700' icon={ faGithub } /> 
                            </a>
                            <a href='https://www.linkedin.com/in/justincaovan/' target='_blank rel="noopener noreferrer"'>
                                <FontAwesomeIcon className='text-xl md:text-2xl text-gray-700 hover:text-green-700' icon={ faLinkedin }/> 
                            </a>
                        </div>
                    </div>
                </div>
